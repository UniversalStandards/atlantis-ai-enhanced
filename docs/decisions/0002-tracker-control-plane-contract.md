...
- Canonical `sourceRevision` is computed from normalized projected fields only, with stable object key ordering, normalized array ordering, and NFC-normalized strings.
