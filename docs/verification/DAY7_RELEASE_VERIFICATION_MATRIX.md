...
| --- | --- | --- | --- |
| Regression suite | Frozen-lockfile install, SEC-20 supply-chain gates, contracts/event-store typecheck and tests | Latest verified runtime baseline is **370/370 contracts + 530/530 event-store = 900/900 tests**. Exact-head evidence anchor `59931f32fc220768104f61ae946889614e751c74` passed Contracts run `33301864587`; frozen install, SEC-20 gates, both TypeScript workspaces, read-only Actions permissions, and zero vulnerability findings at every severity remain green. This CI evidence does not manufacture additional operational capability. | Must remain 100% green on the release candidate |
