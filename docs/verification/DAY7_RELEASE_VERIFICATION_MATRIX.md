...
| --- | --- | --- | --- |
| Regression suite | Frozen-lockfile install, SEC-20 supply-chain gates, contracts/event-store typecheck and tests | Verified documentation baseline `96a92986509f96eda27d707d87168d82dd112669` passed head-associated Contracts run `33223829718`. The underlying implementation head `c54540bcbc0562a5ae074259581508178f0a9e0b` passed head-associated PR-merge run `33222114426`, validating synthetic merge `3e408df4dbb4ae94214c348c1158728d1abe1590`: frozen install, SEC-20 gates, both TypeScript workspaces, and **334/334 contracts + 525/525 event-store = 859/859 tests** passed with read-only Actions permissions and zero vulnerability findings at every severity. Later documentation-only heads inherit that implementation evidence only when their own head-associated CI remains green; they do not constitute new runtime evidence. | Must remain 100% green on the release candidate |
