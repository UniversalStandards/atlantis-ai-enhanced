...
describe("Day-7 rehearsal evidence", () => {
  ...
  it.each([
    ...
    ["whitespace-aliased evidence identity", { ...evidence, evidenceIdentities: ["artifact:release-1", " artifact:release-1 "] }],
  ...
  it.each([
    ...
    ["whitespace-aliased cross-category evidence identity", { ...burnIn, traceCompletenessEvidence: [" regression:1 "] }],
